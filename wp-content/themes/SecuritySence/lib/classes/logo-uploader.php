...
//function add_menu_page( $page_title, $menu_title, $capability, $menu_slug, $function = '', $icon_url = '', $position = null )
        add_menu_page("Change Logo", "Change Logo", 8, "lm_display_logo", "lm_options_page",THEME_URI.'/images/favicon.png');
	//add_submenu_page(__FILE__, "Change", "Change", 8, "lm_display_logo", "lm_options_page");
	}
...
function lm_get_defaults () {
	$lm_option = array();
	$lm_option['url'] =  get_bloginfo(template_url).'/images/logo.jpg';//plugins_url( 'logo.gif' , __FILE__);
	$lm_option['alt'] = get_option('blogname');
	$lm_option['title'] = get_option('blogname').' Logo';
