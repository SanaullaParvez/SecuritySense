...
define('WPPROQUIZ_URL', get_bloginfo(template_url).'/lib/wp-pro-quiz');
define('WPPROQUIZ_FILE', str_replace(' ', '%20',get_bloginfo(template_url).'/lib/wp-pro-quiz/'));
...
function wpProQuiz_pluginLoaded() {
	...
	load_plugin_textdomain('wp-pro-quiz', false,'wp-pro-quiz/languages');
