...
//define('SLIDE_FILE', str_replace(' ', '%20',get_template_directory().'/lib/content-slide/content_slide.php'));
define ( 'DIRNAME',str_replace(' ','%20',get_bloginfo(template_url).'/lib/content-slide'));
$WPContent_slide_plugin_url=DIRNAME;//defined('WP_PLUGIN_URL') ? (WP_PLUGIN_URL . '/' . dirname(plugin_basename(__FILE__))) : trailingslashit(get_bloginfo('wpurl')) . PLUGINDIR . '/' . dirname(plugin_basename(__FILE__)); 
...
define('CONTENT_SLIDE_URL',DIRNAME.'/');
...
'slide_image1'=>DIRNAME.'/images/image1.jpg',
'slide_image2'=>DIRNAME.'/images/image2.jpg',
'slide_image3'=>DIRNAME.'/images/image3.jpg',
'slide_image4'=>DIRNAME.'/images/image4.jpg',
'slide_image5'=>DIRNAME.'/images/image5.jpg',
...
{
//https://localhost/wordpress/wp-admin/admin.php?page=var/www/html/wordpress/wp-content/themes/Security%20Sence/lib/content-slide/content_slide.php
//https://localhost/wordpress/wp-admin/admin.php?page=var/www/html/wordpress/wp-content/themes/Security%20Sence/lib/content-slide/content_slide.php
	$level = 'level_10';
